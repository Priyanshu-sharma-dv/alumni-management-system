  ...
  theme: {
    extend: {
      colors: {
        ...
        secondary: {
          DEFAULT: 'var(--color-secondary)', // blue-gray-500
        ...
        'brand-primary': 'var(--color-brand-primary)', // orange-600
        'brand-secondary': 'var(--color-brand-secondary)', // blue-800
        'conversion-accent': 'var(--color-conversion-accent)', // emerald-500
        'trust-builder': 'var(--color-trust-builder)', // indigo-500
